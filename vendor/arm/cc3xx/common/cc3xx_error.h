...
enum cc3xx_error {
    ...
    CC3XX_ERR_DRBG_INVALID_ENTROPY,
    CC3XX_ERR_DRBG_INVALID_NONCE,
    CC3XX_ERR_DRBG_INVALID_PERSONALIZATION,
    CC3XX_ERR_DRBG_INVALID_ADDITIONAL_INPUT,
    CC3XX_ERR_DRBG_DF_INPUT_TOO_LONG,
    CC3XX_ERR_DCU_LOCKED,
    CC3XX_ERR_DCU_MASK_MISMATCH,
    CC3XX_ERR_KEY_SLOT_NOT_LOCKED,
    _ERROR_MAX,
